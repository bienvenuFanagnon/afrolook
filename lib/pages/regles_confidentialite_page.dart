      ...
      body: ListView(
        ...
        children: [
          ...
          _section(
            ...
            title: 'DÉFI — Nouveau système de compétition',
            items: [
              _rule('Qu\'est-ce qu\'un Défi ?',
                  'Un Défi est un post compétitif lancé par un créateur ou un canal. D\'autres utilisateurs peuvent y répondre avec leur propre post (vidéo, image, audio ou texte). La communauté vote pour désigner les meilleurs participants.'),
              _rule('Comment lancer un Défi',
                  'Lors de la création d\'un post, sélectionne le type "Défi 🏆". Tu dois définir une cagnotte de départ (en AfroCoins, débitée immédiatement), une date de fin, des frais de participation optionnels, des frais de vote optionnels (minimum 5 AfroCoins si activés), et le nombre de gagnants (1, 2 ou 3).'),
              _rule('Participer à un Défi',
                  'Pour participer à un Défi actif, clique sur "Participer" depuis le post original. Si le créateur a fixé des frais de participation, ils te seront débités au moment de l\'inscription. Ta réponse est un nouveau post lié au Défi original.'),
              _rule('Voter pour un participant',
                  'Chaque vote coûte le montant fixé par le créateur du Défi (0 = gratuit, minimum 5 AfroCoins si payant). Tu peux voter plusieurs fois pour le même participant. Les votes se cumulent pour chaque concurrent.'),
              _rule('Classement & résultats',
                  'Les participants sont classés par nombre de votes. En cas d\'égalité, le score du post départage. Le Défi se clôture automatiquement à la date de fin définie par le créateur.'),
              _rule('Distribution des gains',
                  'La cagnotte finale (mise de départ + frais de participation + frais de vote collectés) est distribuée aux gagnants selon la répartition choisie : 1 gagnant → 100 % ; 2 gagnants → 70 % / 30 % ; 3 gagnants → 60 % / 30 % / 10 %. Afrolook prélève 30 % de chaque paiement (participation et votes) pour assurer le fonctionnement de la plateforme.'),
              _rule('Règles du Défi',
                  'Les réponses à un Défi doivent respecter les règles générales de publication d\'Afrolook. Tout contenu signalé ou modéré est automatiquement exclu du Défi. Le créateur du Défi ne peut pas voter pour ses propres participants pour éviter les conflits d\'intérêts.'),
              _rule('Défi expiré',
                  'Un Défi clôturé n\'accepte plus de nouvelles participations ni de votes. Les gains sont distribués automatiquement après vérification. Un Défi sans participants à expiration est remboursé à son créateur.'),
            ],
          ),
          _section(
            colors,
