...
class _CoinRechargeScreenState extends State<CoinRechargeScreen> {
  ...
  // ── Écran iOS (App Store) — IAP uniquement ───────────────────────────────

  Widget _buildAppleStoreScreen(BuildContext context, AppColors colors) {
    return Scaffold(
      backgroundColor: colors.background,
      appBar: AppBar(
        title: Text(
          ...
          child: Column(
            ...
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Les achats de pièces sur iOS se font via In-App Purchase. Bientôt disponible.',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.info_outline_rounded, color: colors.textSecondary, size: 15),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        'Les prix affichés incluent les frais Apple (15%). Après déduction, vous recevez le même nombre de pièces qu\'ailleurs.',
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: pack.isPopular ? colors.accent : colors.border,
                              ...
                              Column(
                                children: [
                                  Container(
                                    ...
                                    child: Center(child: Text(pack.icon, style: const TextStyle(fontSize: 30))),
                                  ),
