...
class UserVideoFeedTiktokPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Vos vidéos TikTok',style: TextStyle(color: Colors.red,fontWeight: FontWeight.w900),),
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('userId',isEqualTo: authProvider.loginUserData.id)
    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Admin delete button
          if (authProvider.loginUserData.role == UserRole.ADM.name ||authProvider.loginUserData.role == video.userId )
            Positioned(
              top: 8,
              left: 8,
              child: IconButton(
  ...
  Future<void> _handleVideoTap(BuildContext context, VideoModel video) async {
    ...
    try {
      ...
      final hasViewed = userData.viewedVideos.contains(video.id) ||
