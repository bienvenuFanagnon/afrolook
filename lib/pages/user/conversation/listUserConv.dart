                ...
                StreamBuilder<UserData>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Stack(
                        children: [
                          CircleAvatar(
                            backgroundImage: NetworkImage("${chat!.chatFriend!.imageUrl!}"),
                            maxRadius: 25,
                          ),
                          Positioned(
                            bottom: 3,
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("@${chat!.chatFriend!.pseudo!}", style: TextStyle(fontSize: 16),),
                        SizedBox(height: 6,),
...
// Obtenez la liste des utilisateurs
                  ...
                  Positioned(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                        width: 12,
                        height: 12,
                        color:amigo.friend!.state==UserState.ONLINE.name? Colors.green:Colors.blueGrey,
                      ),
                    ),
                  )
                ],
  ...
  Stream<List<Chat>> getAllChatsData() async* {
    ...
    // Définissez la requête
    var chatsStream = FirebaseFirestore.instance.collection('Chats').where( Filter.or(
      ...
      body: ListView(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          SizedBox(width: 2,),
                          Text("Amis",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
                        ],
                      ),
                    ),
                  )
       ...
       Padding(
          ...
          Padding(
            ...
            child: Text("Enligne",style: TextStyle(color: Colors.green),),
          ),
