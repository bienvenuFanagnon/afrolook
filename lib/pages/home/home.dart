                ...
                return Container(
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      :!isInvite(user.autreInvitationsEnvoyerId!,authProvider.loginUserData.id!)?
                  Padding(
                    padding: const EdgeInsets.only(top: 8.0,bottom:8 ),
                    child: Container(
                      //width: 120,
                      ...
                      child: ElevatedButton(
                        onPressed:inviteTap?
                            ()  { }:
                            ()async{
                    if (!isInvite(user.autreInvitationsEnvoyerId!,authProvider.loginUserData.id!)) {
                      setState(() {
                        inviteTap=true;
                      });
                      ...
                      await  userProvider.sendInvitation(invitation,context).then((value) async {
                        if (value) {
                          ...
                          user.autreInvitationsEnvoyerId!.add(authProvider.loginUserData.id!);
               ...
               Container(
                 ...
                 child: ElevatedButton(
                   onPressed:abonneTap?
                       ()  { }:
                       ()async{
                         if (!isUserAbonne(user.userAbonnesIds!,authProvider.loginUserData.id!)) {
                           setState(() {
                             abonneTap=true;
                           });
                           ...
                           await  userProvider.sendAbonnementRequest(userAbonne,user,context).then((value) async {
                             if (value) {
                               ...
                               user.userAbonnesIds!.add(authProvider.loginUserData.id!);
                               userProvider.updateUser(user);
                               ScaffoldMessenger.of(context).showSnackBar(snackBar);
                               setState(() {
                                 abonneTap=false;
                        ...
                        Row(
                          children: [
                            ...
                            StatefulBuilder(
                                ...
                                builder: (BuildContext context, void Function(void Function()) setState) {
                                  return Container(
                                  child: isUserAbonne(post.user!.userAbonnesIds!, authProvider.loginUserData.id!)?Container(): TextButton(

                                      onPressed:abonneTap?
                                          ()  { }:
                                          ()async{
                                        if (!isUserAbonne(post.user!.userAbonnesIds!, authProvider.loginUserData.id!)) {
                                          setState(() {
                                            abonneTap=true;
                                          });
                                          UserAbonnes userAbonne = UserAbonnes();
                                          ...
                                          await  userProvider.sendAbonnementRequest(userAbonne,post.user!,context).then((value) async {
                                            if (value) {
                                              ...
                                              userProvider.updateUser(post.user!);
                                              if (post.user!.oneIgnalUserid!=null&&post.user!.oneIgnalUserid!.length>5) {
                                                await authProvider.sendNotification(
                                                    userIds: [post.user!.oneIgnalUserid!],
                                                    smallImage: "${authProvider.loginUserData.imageUrl!}",
          ...
          body:  Center(
            child: Padding(
              ...
              child: Consumer<PostProvider>(
                  ...
                  return postListProvider.listConstposts.isEmpty?CircularProgressIndicator(): FutureBuilder<List<Post>>(
                      // future: postProvider.getPostsImages(limitePosts),
                      future: postListProvider.getPostsImagesAlready(),
                      builder: (BuildContext context,
