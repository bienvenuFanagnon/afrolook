...
class _MyHomePageState extends State<MyChat> {
              ...
              child:  StreamBuilder<UserData>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Stack(
                      children: [
                        CircleAvatar(
                          backgroundImage: NetworkImage("${widget.chat.receiver!.imageUrl!}"),
                         // maxRadius: 30,
                        ),
                        Positioned(
                          bottom: 3,
            ...
            Column(
              ...
              children: [
                ...
                TextCustomerUserTitle(
                  titre: "${formatNumber(widget.chat.receiver!.abonnes!)} abonné(s)",
                      ...
                      //reverse: true,
                        ...
                        itemBuilder: (context, index) {
                         ...
                         //list[index].userAbonnes=[];
                          ...
                          ):list[index].messageType==MessageType.image.name?
                          BubbleNormalImage(
                            id: 'id001',
                            image: _image(),
                            color: Colors.blue,
