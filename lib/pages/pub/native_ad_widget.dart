...
class _NativeAdWidgetState extends State<NativeAdWidget> {
  ...
  void initState() {
    super.initState();
    _checkPremiumStatus();
    _setupAdCallbacks();      // ✅ Appel à la bonne méthode
  }
  ...
  void _setupAdCallbacks() {
    Appodeal.setBannerCallbacks(
      ...
      // Les autres callbacks sont optionnels, vous pouvez les ajouter si besoin
      onBannerShown: () => print('Banner shown'),
      onBannerClicked: () => print('Banner clicked'),
  ...
  Future<void> _checkPremiumStatus() async {
    try {
      ...
      if (mounted) {
        ...
        // Vérification initiale : si l'ad est déjà chargée
        _adIsLoaded = await Appodeal.isLoaded(AppodealAdType.Banner) ?? false;
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Condition clé : n'afficher que si l'ad est chargée
    if (!_adIsLoaded) return const SizedBox.shrink();
