...
class GagnerPointInfo extends StatefulWidget {
  const GagnerPointInfo({super.key});

  @override
  State<GagnerPointInfo> createState() => _AppInfosState();
}

class _AppInfosState extends State<GagnerPointInfo> {
              ...
              children: <Widget>[
                ...
                authProvider.loginUserData.role!=UserRole.ADM.name?Container():  Container(
                  ...
                  child: ElevatedButton(onPressed: () {
                    Navigator.push(context,  MaterialPageRoute(builder: (context) => NewGratuitInfo(),));
                  }, child: Row(
                    children: [
                      Icon(Icons.add),
                      Text("Nouvelle"),
