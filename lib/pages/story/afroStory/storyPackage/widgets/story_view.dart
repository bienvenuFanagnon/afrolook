    ...
    void _showOptionsDialog(BuildContext context) {
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text('Options'),
            content: Text('Voulez-vous supprimer cette story ?'),
            actions: [
              TextButton(
                child: Text('Annuler'),
                onPressed: () {
              ...
              TextButton(
                ...
                onPressed: () {
                  // Ajoutez ici la logique pour supprimer la story
                  Navigator.of(context).pop();
                },
              ),
            ],
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        }, icon: Icon(Icons.read_more_sharp,color: Colors.white,size: 30,))
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            }, icon: Icon(Icons.read_more_sharp,color: Colors.white,size: 20,))
