...
class StatutText extends StatefulWidget {
  @override
  State<StatutText> createState() => _StatutTextState();
}

class _StatutTextState extends State<StatutText> {
...
class StatutTextImage extends StatefulWidget {
  @override
  State<StatutTextImage> createState() => _StatutTextImageState();
}

class _StatutTextImageState extends State<StatutTextImage> {
  final _formKey = GlobalKey<FormState>();
