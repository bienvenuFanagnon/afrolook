                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          nombreDeCrypto = double.parse(value);
                          deviseFcfa = nombreDeCrypto * authProvider.appDefaultData.tarifPubliCash_to_xof!; // Taux de change fictif
                        });
                      },
                    ),
                  ),
                  SizedBox(height: 20,),
                  Text(
                    '${deviseFcfa.toStringAsFixed(2)} FCFA',
                    style: TextStyle(
                      fontSize: 18.0,
                    ),
                  ),
                  ...
                  Visibility(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('Faire une demande de dépôt',style: TextStyle(fontSize: 15),),
                    ),
                  ),
                  Visibility(
                    visible: demandeDeDepot,
