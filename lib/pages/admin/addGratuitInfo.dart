...
class NewGratuitInfo extends StatefulWidget {

  @override
  State<NewGratuitInfo> createState() => _NewGratuitInfoState();
}

class _NewGratuitInfoState extends State<NewGratuitInfo> {
                      ...
                      onTap:onTap?(){}: () async {
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          try {
                            ...
                            infos.type = InfoType.GRATUIT.name;
