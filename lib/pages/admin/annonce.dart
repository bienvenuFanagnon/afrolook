...
class NewAppAnnonce extends StatefulWidget {
  ...
  @override
  State<NewAppAnnonce> createState() => _NewAppInfoState();
}

class _NewAppInfoState extends State<NewAppAnnonce> {
  final _formKey = GlobalKey<FormState>();

  GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  final TextEditingController _titreController = TextEditingController();
  final TextEditingController _nbrJrController = TextEditingController();
                      ...
                      onTap:onTap?(){}: () async {
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          //  infos.description = _descriptionController.text;
                            ...
                            infos.vues = 0;
                            infos.jour = int.parse(_nbrJrController.text);
                           // infos.type = InfoType.APPINFO.name;
                            if (listimages.isNotEmpty) {
                              ...
                              notif.id=firestore
                                  ...
                                  .doc()
                                  .id;
                              notif.titre="Nouvelle Annonce";
                              notif.description="Une nouvelle annonce a été publié !";
                              notif.users_id_view=[];
                              notif.receiver_id="";
