...
Widget HomePostUsersWidget2(Post post,Color color, double height, double width,BuildContext context) {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                            onPressed: () {
                              showPostMenuModalDialog(post,context);
                            },
                            icon: Icon(
                              Icons.more_horiz,
                              size: 30,
                            ...
                            return GestureDetector(
                              ...
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  ...
                                  SnackBar(backgroundColor:Colors.red, content: Text('Vous devriez appuyer deux fois !',style: TextStyle(color: Colors.white),)),
                                );
                                // Navigator.push(
                                //     context,
                                //     MaterialPageRoute(
                              ...
                              onDoubleTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    ...
                                    content: Text(
                                      '🎁 Félicitations ! Vous venez d\'envoyer un cadeau à @${post.user!.pseudo}. Il vous remercie beaucoup. 🎉',
