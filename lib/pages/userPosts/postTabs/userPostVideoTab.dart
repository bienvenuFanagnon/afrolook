...
class _UserPubVideoState extends State<UserPubVideo> {
  ...
  // ==================== SECTION PUBLICITÉ (ADMIN UNIQUEMENT) ====================
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isAdvertisement) ...[
            ...
            Container(
              padding: EdgeInsets.all(8),
              decoration: BoxDecoration(color: _backgroundColor, borderRadius: BorderRadius.circular(12), border: Border.all(color: Colors.grey[700]!)),
              child: Row(
                  ...
                  return Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: isSelected ? _secondaryColor : Colors.transparent, borderRadius: BorderRadius.circular(8)),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(entry.value['icon'], color: isSelected ? Colors.black : _hintColor, size: 16),
                            SizedBox(width: 4),
                            Text(entry.value['label'], style: TextStyle(color: isSelected ? Colors.black : _hintColor, fontSize: 12, fontWeight: isSelected ? FontWeight.bold : FontWeight.normal)),
                          ],
                        ),
                      ),
                    ),
            ...
            Container(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (_isAdvertisement && (value == null || value.isEmpty)) return 'Le lien est requis';
                  if (_isAdvertisement && value != null && value.isNotEmpty && !value.startsWith('http')) return 'Le lien doit commencer par http:// ou https://';
                  return null;
                },
              ),
            ),
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<int>(
                  ...
                  items: _durationOptions.map((days) {
                    String label;
                    if (days < 30) label = '$days jours';
                    else if (days == 30) label = '1 mois';
                    else if (days == 90) label = '3 mois';
                    else if (days == 180) label = '6 mois';
                    else if (days == 365) label = '12 mois';
            ...
            if (_selectedDurationDays != null)
              Padding(
                padding: EdgeInsets.only(top: 8),
                child: Text('La publicité sera active pendant $_selectedDurationDays jours', style: TextStyle(color: _hintColor, fontSize: 12, fontStyle: FontStyle.italic)),
              ),
          ],
        ],
      ),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildAdvertisementCard(), // Section publicité (admin uniquement)
                Container(
