...
// Méthode pour initialiser la pub récompensée
  @override
  void initState() {
    super.initState();
    ...
    _setupRestrictions();
    _checkPostCooldown();
    // ✅ SIMULATION : Cooldown de 30 secondes pour tester rapidement
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Regardez une pub pour poster maintenant',
                              style: TextStyle(
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  validator: (value) {
                                    ...
                                    if (!value.contains('#')) {
                                      return 'Ajoutez au moins un hashtag (#) à votre texte';
                                    }
                                    return null;
                                  },
                                ),
