...
class MesLookChallengeListPage extends StatefulWidget {
  // final Challenge challenge;
  MesLookChallengeListPage({super.key});
  @override
  State<MesLookChallengeListPage> createState() => _MesLookChallengeListPageState();
}

class _MesLookChallengeListPageState extends State<MesLookChallengeListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        titleSpacing: 0,
        title: Text('Mes Looks Challenges 🔥🎁🏆',style: TextStyle(color: Colors.white,fontSize: 18),),
        actions: [
          Padding(
          ...
          child: Column(
            children: [
              ...
              FutureBuilder<List<LookChallenge>>(
                future: postProvider.getAllLookChallengesByUser(authProvider.loginUserData.id!),
