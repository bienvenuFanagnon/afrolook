...
class ChallengeUserChosePost extends StatefulWidget {
  final UserData otherUser;
  final Challenge challenge;
  const ChallengeUserChosePost({super.key, required this.otherUser, required this.challenge});

  @override
  State<ChallengeUserChosePost> createState() => _ChallengeUserChosePostState();
}

class _ChallengeUserChosePostState extends State<ChallengeUserChosePost> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        titleSpacing: 0,
        title: Text('Afrolook Challenges 🔥🎁🏆',style: TextStyle(color: Colors.green,fontSize: 18),),
      ),
          ...
          child: SingleChildScrollView(
            ...
            child:  Padding(
              ...
              child: StreamBuilder<List<Post>>(
                stream: postProvider.getChallengePostsImagesByUser(widget.otherUser.id!),
                    ...
                    return  Column(
                      ...
                      children: [
                        for(Post p in snapshot.data!)
                          Padding(
                            padding: const EdgeInsets.only(top: 5.0,bottom: 5),
                            child: homeChallengePostUsers(widget.challenge,p,Colors.brown,
                                // _color,
                                height,
                                width,context),
                          )
